...
const SearchProduct = () => {
    ...
    return (
        <div>
            ...
            <Button className="mt-[26px] mb-[20px] mx-auto bg-white border-2 text-black hover:text-white border-[#E2E2E4] rounded-[53px] p-[7px] px-[11px]  h-full hover:drop-shadow-[10px_9px_22px_rgba(20,78,227,0.38)] flex items-center gap-2" >
